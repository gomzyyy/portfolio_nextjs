...
export const r = {
    ...
    SWITCHING_PROTOCOLS: { code: 101, message: "Switching to new protocol as requested." },
    ...
    FOUND: { code: 302, message: "Resource found, temporarily at a different URI." },
    NOT_MODIFIED: { code: 304, message: "Resource not modified since last request." },
    TEMPORARY_REDIRECT: { code: 307, message: "Temporary redirect, use original request method." },
    PERMANENT_REDIRECT: { code: 308, message: "Permanent redirect, use original request method." },
    ...
    CONFLICT: { code: 409, message: "Request conflict with the current state of the resource." },
    UNPROCESSABLE_ENTITY: { code: 422, message: "Request is well-formed but cannot be processed." },
  
    // Server error responses (500–599)
    INTERNAL_SERVER_ERROR: { code: 500, message: "Server encountered an internal error." },
    NOT_IMPLEMENTED: { code: 501, message: "Server does not support the request method." },
    ...
    GATEWAY_TIMEOUT: { code: 504, message: "Upstream server did not respond in time." },
  };